...
| **PDF** | Headings inferred from font-size ratios; paragraph flow sorted top-to-bottom; embedded images are extracted | Text-based PDFs only — scanned / image PDFs are not supported; complex multi-column layouts may reorder |
